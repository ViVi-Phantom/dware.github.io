...
function popup1() {
    CreativaPopup.create('Feel free to DM me ! LeakerByDragonシ#0049 &#10084', 'Discord');
}
...
function popup13() {
    CreativaPopup.create('Feel free to DM me <font class="contactding" onclick="allahm109kd(); allahm109kd2();" color="#FF0000">! LeakerByDragonシ#0049</font> &#10084<br> <font style="color: #696969; font-size: smaller;"> or join my discord server <a href="https://discord.gg/QmSMGBEVkn" style="color: #ADD8E6;">https://discord.gg/QmSMGBEVkn</a> </font>', 'Discord', '', {
        titleColor: '#6ffcff',
        textColor: '#b0b0b0'
    });
...
function allahm109kd() {
    navigator.clipboard.writeText("! LeakerByDragonシ#0049");
    setTimeout(function() {
